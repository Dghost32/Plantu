...
function useListbox(props) {
  ...
  const defaultIdGenerator = React23.useCallback((_2, index) => `${id}-option-${index}`, [id]);
...
function getOptionsFromChildren(children2) {
  ...
  React35.Children.forEach(children2, (node2) => {
...
var MultiSelectUnstyled = React39.forwardRef(function MultiSelectUnstyled2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime17.jsxs)(React39.Fragment, {
    children: [(0, import_jsx_runtime16.jsx)(Button3, _extends({}, buttonProps, {
...
function useTabsList(parameters) {
  ...
  const processChildren = React57.useCallback(() => {
    ...
    let childIndex = 0;
    const processedChildren = React57.Children.map(children2, (child) => {
...
function Ripple(props) {
  ...
  const [leaving, setLeaving] = React81.useState(false);
...
var TouchRipple = React82.forwardRef(function TouchRipple2(inProps, ref) {
  ...
  const [ripples, setRipples] = React82.useState([]);
  const nextKey = React82.useRef(0);
  const rippleCallback = React82.useRef(null);
  React82.useEffect(() => {
  ...
  const ignoringMouseDown = React82.useRef(false);
  const startTimer = React82.useRef(null);
  const startTimerCommit = React82.useRef(null);
  const container = React82.useRef(null);
  React82.useEffect(() => {
    return () => {
      clearTimeout(startTimer.current);
    };
  }, []);
  const startCommit = React82.useCallback((params) => {
    const {
      pulsate: pulsate2,
      rippleX,
      rippleY,
  ...
  const start2 = React82.useCallback((event = {}, options = {}, cb = () => {
  }) => {
    const {
  ...
  const pulsate = React82.useCallback(() => {
    start2({}, {
      pulsate: true
    });
  }, [start2]);
  const stop = React82.useCallback((event, cb) => {
    clearTimeout(startTimer.current);
...
var ButtonBase = React83.forwardRef(function ButtonBase2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiButtonBase"
  });
  ...
  const rippleRef = React83.useRef(null);
  ...
  const keydownRef = React83.useRef(false);
...
var ButtonGroupContext = React84.createContext({});
if (true) {
...
var Button = React85.forwardRef(function Button2(inProps, ref) {
  ...
  const startIcon = startIconProp && (0, import_jsx_runtime54.jsx)(ButtonStartIcon, {
    className: classes.startIcon,
    ownerState,
    children: startIconProp
  });
  const endIcon = endIconProp && (0, import_jsx_runtime54.jsx)(ButtonEndIcon, {
    className: classes.endIcon,
    ownerState,
    children: endIconProp
  });
  return (0, import_jsx_runtime55.jsxs)(ButtonRoot, _extends({
    ownerState,
